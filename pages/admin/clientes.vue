    ...
    >
      ...
      <tbody>
        ...
        >
          ...
          <td class="px-6 py-4">Ivan Mendoza</td>
          <td class="px-6 py-4">V18329422</td>
          <td class="px-6 py-4">584127132625</td>
          <td class="px-6 py-4">
            Av. Principal Montalban, Apto. 35 Piso 3, Residencias Amapola
          </td>
          <td class="px-6 py-4">Paga al dia</td>
          <td class="px-6 py-4">
